...
int maps_reveille[NB_LEVELS][MAP_HEIGHT][MAP_WIDTH] = {
    ...
    {       
        {2,   2,   2,   2,   2,   2,   2,   2,   0,   0,   0, 0, 2, 649, 650, 651,   2,   2, 2, 2}, // Trou en haut
        {2,   2,   2,   0, 583, 584,   2, 587,   0,   0,   0, 0, 2, 646, 647, 648,   2,   2, 2, 2},
        {2,   2,   2,   0, 581, 582, 585, 586,   0,   0,   0, 0, 0, 643, 644, 645,   0,   0, 2, 2},

...
235 = écharpe
236 = bas de pyj
237,238 = bas commode maquillage
239,240 = haut commode maquillage
241 = fauteil
*/
...
int maps[NB_LEVELS][MAP_HEIGHT][MAP_WIDTH] = {
 ...
 {      //carte 1 (chambre) index 0
    ...
    {    
        ...
        {2, 2,  2,  2,  2,  2,  2,239,240, 2,  2,  2, 2,210,211,212, 2, 2, 2, 2},
        {2, 2,  0,  0,  0,  0,217,237,238, 0,229,  0, 0,207,208,209, 0, 0, 2, 2},
